...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("voice_call_mic_denied", "Microphone permission is required for voice calls. Please grant it in Settings > Apps > Nomad > Permissions."),
        ...
        ("verify_nomad_password_tip", "Verify Nomad password"),
        ...
        ("powered_by_me", "Built on RustDesk (AGPL-3.0)"),

...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "Langue"),
        ("Keep Nomad background service", "Garder le service Nomad en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l'application Nomad, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("voice_call_mic_denied", "L'autorisation du microphone est nécessaire pour les appels vocaux. Veuillez l'accorder dans Paramètres > Applications > Nomad > Autorisations."),
        ...
        ("Auto-accept voice calls", "Accepter automatiquement les appels vocaux"),
        ...
        ("verify_nomad_password_tip", "Vérifier le mot de passe Nomad"),
        ...
        ("powered_by_me", "Basé sur RustDesk (AGPL-3.0)"),
